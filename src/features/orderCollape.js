				...
				<div className="row">
					...
					<div className="payment-option">
						<div className="row " align="center">
							<p><a href="/ชำระเงิน" ><button className="btn btn-info" onClick={() => this.handlePayment()}>ชำระเงิน</button></a></p>
							<p><button type="button" className="btn btn-success" onClick={() => this.handleAddToCart()}>ใส่ตะกร้า</button></p>
						</div>
					</div>
					</div>
				</div>
